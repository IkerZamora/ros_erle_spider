...
//	start_flag = false;
	...
	move_body_pub = node.advertise<spider_msgs::BodyState>("/teleop/move_body",1);
	body_cmd_pub = node.advertise<spider_msgs::BodyCommand>("/teleop/body_command",1);
	gait_cmd_pub = node.advertise<spider_msgs::GaitCommand>("/teleop/gait_control",1);
}
