...
typedef boost::shared_ptr<spider_msgs::LegsJointsState const> LegsStateConstPtr;
...
{
	ros::init(argc, argv, "spider_joint_publisher");
	ros::NodeHandle node;

	joint_msg_pub = node.advertise<sensor_msgs::JointState>("spider_joint_publisher", 1);
