...
bool GaitKinematics::init() {
	...
	gait_control_sub = node.subscribe<spider_msgs::GaitCommand>("/teleop/gait_control", 1, &GaitKinematics::teleopGaitCtrl, this);
...
void GaitKinematics::teleopGaitCtrl (const spider_msgs::GaitCommandConstPtr &gait_cmd){
